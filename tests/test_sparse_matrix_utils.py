...
def test_intersect() -> None:
    ...
    automaton_trans = sparse_matrix_utils.sparse_matrix_to_nfa(
        sparse_matrix_utils.intersect(
            sparse_matrix_utils.nfa_to_sparse_matrix(automaton),
            sparse_matrix_utils.nfa_to_sparse_matrix(automaton1),
        )
    )
...
def test_nfa_to_sparse_matrix_and_back() -> None:
    ...
    dfa = sparse_matrix_utils.sparse_matrix_to_nfa(
        sparse_matrix_utils.nfa_to_sparse_matrix(expected_dfa)
    )
